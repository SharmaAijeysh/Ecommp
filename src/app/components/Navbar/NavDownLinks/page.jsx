    ...
    return (
        <div className=" bg-[#2468B7] p-4 h-[68px] text-white  font-[Poppins] font-normal text-base leading-4 flex  justify-between">
            <div className="flex w-full ml-8 gap-4">
                ...
                <button onMouseEnter={()=>setClickedLink("l2")} className="flex justify-center items-center gap-1">Accessories<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
                </button>
                <button onMouseEnter={()=>setClickedLink("l3")} className="flex justify-center items-center gap-1">Gaming<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
                </button>
                <button onMouseEnter={()=>setClickedLink("l4")} className="flex justify-center items-center gap-1">Features<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
                </button>
                <button onMouseEnter={()=>setClickedLink("l5")} className="flex justify-center items-center gap-1">PC Builder<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
                </button></div>
